...
- (void)viewDidLoad {
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"textData" ofType:@"plist"];
    
    NSDictionary *dict = [[NSDictionary alloc]
                          initWithContentsOfFile:path];
    NSString *htmlText=[dict objectForKey:@"TermsAndConditions"];
    self.backBtn.imageEdgeInsets = UIEdgeInsetsMake(10, 10, 10, 20);

    [self.textView setValue:htmlText forKey:@"contentToHTMLString"];
    //self.textView.textColor=[UIColor lightGrayColor];
    self.textView.font=[UIFont fontWithName:Regular size:13.0f];
