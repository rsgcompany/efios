...
//        
//    }
//    btnTemp.backgroundColor=[UIColor colorWithRed:(147/255.0) green:(189/255.0) blue:(119/255.0) alpha:1];
//    [btnTemp setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
//    btnTemp.layer.borderColor=[UIColor colorWithRed:(147/255.0) green:(189/255.0) blue:(119/255.0) alpha:1].CGColor;
